...
template<>
struct hash<caf::variant<caf::io::connection_handle, caf::io::dgram_handle>> {
  size_t operator()(const caf::variant<caf::io::connection_handle,
                                       caf::io::dgram_handle>& hdl) const {
...
class routing_table {
public:
  using endpoint_handle = variant<connection_handle, dgram_handle>;
